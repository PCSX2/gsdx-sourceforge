...
@unSwizzleBlock32_x86_sse2@12 proc public
...
@unSwizzleBlock32_x86_sse2@12 endp

;
; unSwizzleBlock16
;

@unSwizzleBlock16_x86_sse2@12 proc public
...
@unSwizzleBlock16_x86_sse2@12 endp

;
; unSwizzleBlock8
;

@unSwizzleBlock8_x86_sse2@12 proc public
...
@unSwizzleBlock8_x86_sse2@12 endp

;
; unSwizzleBlock4
;

@unSwizzleBlock4_x86_sse2@12 proc public
...
@unSwizzleBlock4_x86_sse2@12 endp

;
; unSwizzleBlock8HP
;

@unSwizzleBlock8HP_x86_sse2@12 proc public
...
@unSwizzleBlock8HP_x86_sse2@12 endp

;
; unSwizzleBlock4HLP
;

@unSwizzleBlock4HLP_x86_sse2@12 proc public
...
@unSwizzleBlock4HLP_x86_sse2@12 endp

;
; unSwizzleBlock4HHP
;

@unSwizzleBlock4HHP_x86_sse2@12 proc public
...
@unSwizzleBlock4HHP_x86_sse2@12 endp

;
; unSwizzleBlock4P
;

@unSwizzleBlock4P_x86_sse2@12 proc public
...
@unSwizzleBlock4P_x86_sse2@12 endp
...
@SwizzleBlock32_x86_sse2@16 proc public
	...
	mov			eax, [esp+8+8]
	cmp			eax, 0ffffffffh
	jnz			SwizzleBlock32_x86_sse2@WM
...
@SwizzleBlock32_x86_sse2@16 endp

;
; SwizzleBlock16
;

@SwizzleBlock16_x86_sse2@12 proc public
...
@SwizzleBlock16_x86_sse2@12 endp

;
; SwizzleBlock8
;

@SwizzleBlock8_x86_sse2@12 proc public
...
@SwizzleBlock8_x86_sse2@12 endp

;
; SwizzleBlock4
;

@SwizzleBlock4_x86_sse2@12 proc public
...
@SwizzleBlock4_x86_sse2@12 endp
...
@SwizzleBlock32u_x86_sse2@16 proc public
	...
	mov			eax, [esp+8+8]
	cmp			eax, 0ffffffffh
	jnz			SwizzleBlock32u_x86_sse2@WM
...
@SwizzleBlock32u_x86_sse2@16 endp

;
; SwizzleBlock16u
;

@SwizzleBlock16u_x86_sse2@12 proc public
...
@SwizzleBlock16u_x86_sse2@12 endp

;
; SwizzleBlock8u
;

@SwizzleBlock8u_x86_sse2@12 proc public
...
@SwizzleBlock8u_x86_sse2@12 endp

;
; SwizzleBlock4u
;

@SwizzleBlock4u_x86_sse2@12 proc public
...
@SwizzleBlock4u_x86_sse2@12 endp
