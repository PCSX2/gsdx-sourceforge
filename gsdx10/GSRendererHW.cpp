...
{
	m_tc = new GSTextureCacheHWDX10(this, !!AfxGetApp()->GetProfileInt(_T("Settings"), _T("nativeres"), FALSE));
...
void GSRendererHWDX10::Draw()
{
	...
	GSTextureCache<GSDeviceDX10>::GSRenderTarget* rt = m_tc->GetRenderTarget(TEX0, m_width, m_height);
	...
	GSTextureCache<GSDeviceDX10>::GSDepthStencil* ds = m_tc->GetDepthStencil(TEX0, m_width, m_height);

	// tex

	GSTextureCache<GSDeviceDX10>::GSTexture* tex = NULL;
...
void GSRendererHWDX10::SetupDATE(GSTextureCache<GSDeviceDX10>::GSRenderTarget* rt, GSTextureCache<GSDeviceDX10>::GSDepthStencil* ds)
{
...
bool GSRendererHWDX10::OverrideInput(int& prim, GSTextureCache<GSDeviceDX10>::GSTexture* tex)
{
