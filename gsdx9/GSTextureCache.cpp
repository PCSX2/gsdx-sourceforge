...
GSTextureCacheHWDX9::GSTextureCacheHWDX9(GSRenderer<GSDeviceDX9>* renderer, bool nativeres)
	: GSTextureCache<GSDeviceDX9>(renderer, nativeres)
{
}

// GSRenderTargetHWDX9

void GSTextureCacheHWDX9::GSRenderTargetHWDX9::Update()
{
	__super::Update();
...
void GSTextureCacheHWDX9::GSRenderTargetHWDX9::Read(CRect r)
{
...
void GSTextureCacheHWDX9::GSDepthStencilHWDX9::Update()
{
}

// GSTextureHWDX9

bool GSTextureCacheHWDX9::GSTextureHWDX9::Create()
{
...
bool GSTextureCacheHWDX9::GSTextureHWDX9::Create(GSRenderTarget* rt)
{
	rt->Update();
...
bool GSTextureCacheHWDX9::GSTextureHWDX9::Create(GSDepthStencil* ds)
{
	m_rendered = true;
...
void GSTextureCacheHWDX9::GSTextureHWDX9::Update()
{
	__super::Update();
